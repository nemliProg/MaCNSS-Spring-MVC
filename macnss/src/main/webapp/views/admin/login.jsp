        ...
        <div class="flex justify-center h-screen">
            <div class="hidden bg-cover lg:block lg:w-2/3" id="banner">
                <div class="flex items-center h-full px-20 bg-gray-900 bg-opacity-40">
                    <div>
                        <div class="text-2xl block rounded-full w-44 font-bold text-white">
                            <img class="w-full" src="https://lobservateur.info/uploads/imported_images/uploads/2017/10/cnss.png" alt="CNSS Logo">
                        </div>
                        <p class="max-w-xl mt-3 text-gray-300">
                            Welcome Admin to the CNSS Portal.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
                <div class="flex-1">
                    <div class="text-center">
                        <h2 class="text-2xl m-auto w-24 font-bold text-center text-gray-700 ">
                            <img class="w-full" src="https://lobservateur.info/uploads/imported_images/uploads/2017/10/cnss.png" alt="CNSS Logo">
                        </h2>
